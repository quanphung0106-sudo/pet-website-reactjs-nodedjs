...
const Benefits = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY >= 900 && window.scrollY < 1521) {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.item}>
        {show && (
          <div
            className={`${styles.topItem} ${scrollY ? styles.activeTopItem : ""}`}
          >
            {show && (
              <img
                className={`${styles.img} ${scrollY ? styles.activeImg : ""}`}
                src="/img/pet.png"
                alt=""
              />
            )}
      ...
      <div className={styles.item}>
        <div className={styles.imgContainer}>
          {show && (
            <img
              className={`${styles.img2} ${scrollY ? styles.activeImg2 : ""}`}
              src="/img/pets.jpg"
              alt=""
            />
          )}
